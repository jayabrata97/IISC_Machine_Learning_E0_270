...
class CifarNet(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Conv2d(in_channels=3, out_channels=256, kernel_size=9)
        self.primary_caps = PrimaryCaps(in_channels=256, out_channels=32*8*8, kernel_size=9, num_capsules=32, out_dimension=8)
        self.secondary_caps = SecondaryCaps(in_channels=32*8*8, out_channels=10, out_dimension=16, in_dimension=8)
